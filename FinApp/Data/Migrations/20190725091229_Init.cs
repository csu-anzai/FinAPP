        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ExpenseCategories_Images_ImageId",
                        column: x => x.ImageId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_IncomeCategories_Images_ImageId",
                        column: x => x.ImageId,
                        principalTable: "Images",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_UserExpenseCategories", x => new { x.ExpenseCategoryId, x.UserId });
                    table.ForeignKey(
                        name: "FK_UserExpenseCategories_ExpenseCategories_ExpenseCategoryId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_UserIncomeCategories", x => new { x.IncomeCategoryId, x.UserId });
                    table.ForeignKey(
                        name: "FK_UserIncomeCategories_IncomeCategories_IncomeCategoryId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ExpenceCategoryId = table.Column<int>(nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AccountId = table.Column<int>(nullable: false),
                    ExpenceCategoryId = table.Column<int>(nullable: false),
                    IncomeCategoryId = table.Column<int>(nullable: true),
                    TransactionId = table.Column<int>(nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ExpenseCategories_ImageId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_IncomeCategories_ImageId",
